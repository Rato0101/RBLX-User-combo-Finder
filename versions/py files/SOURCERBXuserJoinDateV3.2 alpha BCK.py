...
ICON_BASE64 = (
    "AAABAAEAEBAAAAEAIABoBAAAFgAAACgAAAAQAAAAIAAAAAEAIAAAAAAAAAAAAAAAAAAAAAAAAA"
)

# === Colors and constants ===
BG_COLOR = "#1C1C1C"       # Dark background
TEXT_COLOR = "#FFFFFF"     # White text default
ACCENT_COLOR = "#26A0DA"   # Xbox blue accent (used minimally)
XBOX_GREEN = "#00FF00"     # Xbox 360 glow green
BTN_BG_COLOR = "#004400"   # Dark green base for buttons
PROGRESS_BASE = "#008800"  # Base green for progress bar pulse
...
class MetroApp(tk.Tk):
    ...
    def _set_theme(self):
        ...
        # Modern button style (no glowing/hover animation)
        self.style.configure("Metro.TButton",
                             ...
                             borderwidth=0,
                             focusthickness=2,
                             focuscolor=XBOX_GREEN,
                             padding=(12, 8))
        self.style.map("Metro.TButton",
                       background=[("active", "#006600"), ("disabled", "#222")],
                       foreground=[("active", BG_COLOR), ("disabled", "#888")])

        # Label style
        self.style.configure("Metro.TLabel",
                             background=BG_COLOR,
                             foreground=TEXT_COLOR,
                             font=("Consolas", 12))

        # Progressbar style
        self.style.configure("Metro.Horizontal.TProgressbar",
                             troughcolor=BG_COLOR,
                             background=PROGRESS_BASE,
                             bordercolor=BG_COLOR,
                             lightcolor=PROGRESS_BASE,
                             darkcolor=PROGRESS_BASE)

        # Custom XP-style black scrollbar
        self.style.layout("Black.Vertical.TScrollbar",
            [('Vertical.Scrollbar.trough', {'children':
                [('Vertical.Scrollbar.uparrow', {'side': 'top', 'sticky': ''}),
                 ...
                 ('Vertical.Scrollbar.thumb', {'unit': '1', 'children':
                     ...
                     'sticky': 'nswe'})],
                'sticky': 'ns'})])
        self.style.configure("Black.Vertical.TScrollbar",
                             troughcolor="#111111",
                             background="#222222",
                             bordercolor="#000000",
                             arrowcolor="#00FF00",
                             ...
                             relief="flat",
                             borderwidth=2)
        self.style.map("Black.Vertical.TScrollbar",
                       background=[("active", "#333333"), ("!active", "#222222")])
    ...
    def _build_ui(self):
        ...
        self.combos_label = tk.Label(frame_results, text="Combos: 0", bg="#23272A", fg=ACCENT_COLOR, font=("Consolas", 10, "bold"))
        self.combos_label.pack(side="top", anchor="ne", padx=(0, 40), pady=2)

        self.results_box = tk.Text(frame_results, bg="#23272A", fg=TEXT_COLOR,
                                   font=("Consolas", 10, "normal"), relief="flat",
        ...
        tk.Label(gen_frame, text="Generate length:", bg="#181818", fg=TEXT_COLOR, font=("Consolas", 10)).grid(row=0, column=0, padx=6)
        self.gen_length = tk.IntVar(value=5)
        self.gen_length_entry = tk.Spinbox(gen_frame, from_=1, to=7, textvariable=self.gen_length, width=4, font=("Consolas", 10))
        self.gen_length_entry.grid(row=0, column=1, padx=6)

        tk.Label(gen_frame, text="Count:", bg="#181818", fg=TEXT_COLOR, font=("Consolas", 10)).grid(row=0, column=2, padx=6)
        self.gen_count = tk.IntVar(value=100)
        self.gen_count_entry = tk.Spinbox(gen_frame, from_=1, to=10000, textvariable=self.gen_count, width=6, font=("Consolas", 10))
        ...
        tk.Label(manual_frame, text="Manual User Lookup:", bg="#23272A", fg=ACCENT_COLOR, font=("Consolas", 11, "bold")).pack(side="left", padx=(10, 2))
        tk.Label(manual_frame, text="Username:", bg="#23272A", fg=TEXT_COLOR, font=("Consolas", 10)).pack(side="left", padx=(10, 2))
        self.manual_username = tk.Entry(manual_frame, font=("Consolas", 10), width=22, relief="flat", bg="#181818", fg=TEXT_COLOR, insertbackground=TEXT_COLOR)
        ...
        self.manual_result = tk.Text(manual_frame, height=3, width=80, font=("Consolas", 10), bg="#23272A", fg=TEXT_COLOR, relief="flat", bd=2, highlightthickness=1, highlightbackground="#333")
        ...
        self.results_box.tag_configure("skipped", foreground="#FFA500")
        self.results_box.tag_configure("notfound", foreground="#FF4500")
    ...
    def load_file(self):
        ...
        self.title(f"Roblox Finder V3.5.5 - {combo_count} combos loaded")
